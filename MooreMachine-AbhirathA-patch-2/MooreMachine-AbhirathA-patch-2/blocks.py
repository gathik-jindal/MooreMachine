...
class pydig: 
    ...
    def moore(self, maxOutSize, plot=False, blockID=None, nsl=None, ol=None):
        """
        ...
        temp = Machine(self.__env, maxOutSize, nsl, ol, plot, blockID) 
        self.__components.append(temp)
        return temp

    def clock(self, maxOutSize = 1, plot=True, blockID=None, timePeriod=1.2, onTime = 0.6):
        """
        ...
        temp = Clock(self.__env, maxOutSize, plot, blockID, timePeriod, onTime) ########
        self.__components.append(temp)
        return temp
...
class Machine(HasInputConnections, HasOutputConnections):
    ...
    def __init__(self, env, maxOutSize, nsl, ol, plot=False, blockID=None):
        """
